...
import { StepperDisabled } from './stepper--disabled.example';
import { StepperForm } from './stepper--form.example';
import { StepperMinMaxStep } from './stepper--min-max-step.example';
import { StepperNonTypeable } from './stepper--non-typeable.example';
import { StepperPreview, defaultImports, defaultSkeleton } from './stepper.preview';

export const routeMeta: RouteMeta = {
	data: { breadcrumb: 'Stepper', api: 'stepper' },
	meta: metaWith('spartan/ui - Stepper', 'A number input with increment and decrement buttons.'),
...
@Component({
	...
	template: `
		<section spartanMainSection>
			...
			<spartan-install-tabs primitive="stepper" />

			<spartan-section-sub-heading id="usage">Usage</spartan-section-sub-heading>
			<div class="mt-6 space-y-4">
				<spartan-code [code]="_defaultImports" />
				<spartan-code [code]="_defaultStepper" />
			</div>
			...
			<p class="py-2">
				...
				input to disable the stepper.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-stepper-disabled />
				</div>
...
export default class StepperPage {
	...
	protected readonly _defaultStepper = defaultSkeleton;
